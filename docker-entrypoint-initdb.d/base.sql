...
('duree_session_minutes', '60', 'Durï¿½e de vie d''une session en minutes'),
...
CREATE TABLE signalement (
   ...
   description TEXT, -- description de l'ï¿½tat ou du problï¿½me
   niveau INT NOT NULL DEFAULT 1, -- niveau de gravitï¿½ de 1 ï¿½ 10
   photos TEXT, -- URLs/base64 des photos sï¿½parï¿½es par virgules
   photos_json TEXT, -- format metier photos[]
